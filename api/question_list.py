...
3. 内容可以是:更细节的流程、特殊场景、未来规划、协作方关系、数据迁移等
...
| 序号 | 维度 | 提问 |
|------|------|------|
| 1 | 客户协作 | 客户确认样品的流程现在是怎么走的？<br>*服装外贸样品确认往往涉及多轮修改，比较耗时。“修改意见通常通过什么方式传达？有没有版本混乱的情况？”* |
| 2 | 历史数据 | 现有的订单数据需要迁移过来吗？<br>*服装外贸企业通常积累了大量Excel历史数据。“大概有多少历史订单？格式统一吗？”* |
| 3 | 异常处理 | 订单出问题（质量、延期）现在怎么处理？<br>*服装外贸常见异常：质量不达标返工、交期延误、客户临时改单。“这些情况发生时信息怎么传递？谁来判断和处理？”* |
| 4 | 未来规划 | 除了订单管理，还有没有其他想数字化的业务？<br>*服装外贸企业常见延伸场景：供应商管理、库存管理、客户关系维护。“有没有其他部门也有类似的管理需求？”* |
