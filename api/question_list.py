...
3. 每个问题下方必须有 > 💡 补充（小字），这是给服务商的**话术参考**，包含：
   - 直接给出2-3个具体的追问句子（服务商可以直接拿来问客户）
   - 结合行业特征给出具体的场景描述（不要泛泛而谈）
   - 如有常见选项，直接列举（服务商可以读给客户听）
4. 补充内容要具体、可操作，不要写“可以从 XX 维度引导”这种笼统话，而是直接写出具体怎么问
5. 参考知识库中的案例和字段经验池，让补充内容更有行业针对性
...
> 💡 可以这样追问：
> - “比如订单从接单到交货，哪个步骤经常卡住或出差错？”
> - “有没有因为信息没同步到位，导致返工或客户投诉的情况？”
> - “平时最花时间的重复性工作是什么？”
> 该行业客户通常在订单跟进、多方协同、进度汇报环节最痛。

**[业务流程]**

一个订单从开始到结束，中间经过哪些环节和人？

> 💡 可以这样引导：
> - “客户下单之后，第一步是谁来处理？然后传给谁？”
> - “中间有没有需要外部人（供应商/工厂/客户）参与的环节？”
> - “每个环节之间的信息是怎么传递的？微信群还是邮件还是系统？”
> 服装外贸典型流程：接单 → 打样 → 确认 → 生产 → 质检 → 发货。涉及：业务员、设计、工厂、货代。
...
> 💡 可以这样追问：
> - “现在是用Excel还是什么系统在记录？”
> - “这个工具哪里不够用？是功能缺还是太复杂没人用？”
> - “数据能导出来吗？格式是什么？”
> 常见选项：Excel手工台账、微信群接龙、ERP（用友/金蝶）、纸质单据、行业专用软件。
